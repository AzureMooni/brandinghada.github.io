    ...
    <section className="py-24 border-t border-[#22222b]/50 px-6 relative overflow-hidden bg-gradient-to-b from-background to-[#070709]">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="pt-8 border-t border-[#22222b]/30">
          ...
          <div className="max-w-4xl mx-auto bg-[#ffffff] text-slate-800 border-t-8 border-t-secondary border border-slate-200 rounded-3xl p-6 sm:p-12 shadow-2xl relative overflow-hidden text-left mb-10">
            ...
            {/* Clauses List (SEO 최적화를 위해 h3 사용 및 모바일 가독성을 고려한 여백 구성) */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
              {safetyGuarantees.map((item, idx) => (
                <div key={idx} className="group relative flex items-start gap-3.5 leading-[1.6]">
                  <div className="w-9 h-9 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center flex-shrink-0 text-secondary">
                    {item.icon}
                  </div>
                  <div>
                    <span className="text-[10px] font-bold text-secondary tracking-wide uppercase block">
                      {item.clause}
                    </span>
